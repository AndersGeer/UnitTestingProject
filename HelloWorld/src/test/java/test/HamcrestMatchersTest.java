...
public class HamcrestMatchersTest {
    ...
    public void t1(){
        ...
        MatcherAssert.assertThat(list, not(everyItem(IsEven.isEven())));
    }
    @Test
    public void t2(){
        List<Integer> list = Arrays.asList(1, 2, 4,6,8);
        MatcherAssert.assertThat(list, everyItem(IsEven.isEven()));
    }
    ...
    public void t4(){
        String measured = "Hello";
        MatcherAssert.assertThat(measured.length(), IsEven.isEven());
    }
